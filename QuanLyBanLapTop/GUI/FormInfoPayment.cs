...
namespace GUI
{
    public partial class FormInfoPayment : Form
    {
        ...
        public void sumPayment(int idBill)
        {
            ...
            txt_sumPayment.Text = changeMoney(b.Pay.ToString("0"));
        }
        ...
        public void setDataDetailsBill(int idBill)
        {
            ...
            foreach (ChiTietHoaDonDTO item in list)
            {
                ...
                string[] row = new string[] {p.NameProduct,changeMoney( p.UnitPrice.ToString("0")),
                    item.QuantityProduct.ToString(), (item.IntoMoney).ToString("0"),
                    changeMoney(item.MoneyDown.ToString("0")),changeMoney((item.IntoMoney-item.MoneyDown).ToString("0")) };
        ...
        private void btn_editProduct_Click(object sender, EventArgs e)
        {
            ...
            b.TypePay = this.cbb_typePayment.Text;
            b.DateBill = DateTime.Now;
