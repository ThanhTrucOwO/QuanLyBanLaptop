    ...
    public partial class FormSell : Form
    {
        ...
        public void setDataDetailsProduct()
        {
            ...
            foreach (ChiTietHoaDonDTO item in list)
            {
                ...
                string[] row = new string[] {p.IdProduct, p.NameProduct, changeMoney(p.UnitPrice.ToString("0")),
        ...
        public void setDataProduct(List<SanPham> listp)
        {
            ...
            foreach (SanPham p in listp)
            {
                ...
                string[] row = new string[] { p.IdProduct, p.NameProduct,
                    changeMoney(p.UnitPrice.ToString("0")),p.QuantityProduct.ToString(),nameType,nameManu};
        ...
        public void displayInfoProduct(SanPham p,string work,int quantity)
        {
            ...
            this.inp_unitPrice.Text = changeMoney(p.UnitPrice.ToString("0"));
            ...
            this.inp_total.Text = changeMoney(sumMoney.ToString("0"));
            if(work == "edit")
            {
        ...
        private void inp_total_TextChanged(object sender, EventArgs e)
        {
